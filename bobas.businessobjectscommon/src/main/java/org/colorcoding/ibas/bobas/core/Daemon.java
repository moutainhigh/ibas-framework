...
public class Daemon implements IDaemon {
	...
	public ExecutorService getThreadPool() {
		if (this.threadPool == null) {
			...
			this.threadPool = new ThreadPoolExecutor(1, size, 60, TimeUnit.SECONDS, new LinkedBlockingQueue<Runnable>(
					MyConfiguration.getConfigValue(MyConfiguration.CONFIG_ITEM_TASK_THREAD_QUEUE_SIZE, 3)));
		}
		return threadPool;
	}
